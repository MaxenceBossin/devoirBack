...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'userOrdered', targetEntity: Ordered::class, orphanRemoval: true)]
    ...
    public function removeOrdered(Ordered $ordered): self
    {
        if ($this->ordereds->removeElement($ordered)) {
            ...
            if ($ordered->getUserOrdered() === $this) {
                $ordered->setUserOrdered(null);
            }
        }
